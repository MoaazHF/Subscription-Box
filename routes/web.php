...
Route::middleware('auth')->group(function () {
    Route::get('/account/password-change', [AccountSecurityController::class, 'edit'])->name('password.change.edit');
    Route::patch('/account/password-change', [AccountSecurityController::class, 'update'])->name('password.change.update');
    ...
    Route::middleware('force-password-change')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            ...
            Route::post('/ops/warehouse-staff/accounts', [WarehouseStaffController::class, 'createAccount'])->name('warehouse-staff.accounts.store');
            Route::post('/ops/warehouse-staff', [WarehouseStaffController::class, 'store'])->name('warehouse-staff.store');
            Route::patch('/ops/warehouse-staff/{warehouseStaff}', [WarehouseStaffController::class, 'update'])->name('warehouse-staff.update');
            Route::delete('/ops/warehouse-staff/{warehouseStaff}', [WarehouseStaffController::class, 'destroy'])->name('warehouse-staff.destroy');
